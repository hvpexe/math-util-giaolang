...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //OUTPUT: ĐẦU RA ỨNG VÀO XỬ LÍ CỦA HÀM/CHỨC NĂNG CỦA APP, DĨ NHIÊN DÙNG ĐẦU
        //VÀO ĐỂ XỬ LÝ
        //KÌ VỌNG: MONG HÀM SẺ TRẢ VỀ VALUE NÀO ĐÓ ỨNG VỚI INPUT Ở TRÊN
